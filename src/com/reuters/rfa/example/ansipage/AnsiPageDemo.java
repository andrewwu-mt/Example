package com.reuters.rfa.example.ansipage;
...
import com.reuters.rfa.ansipage.GraphicSet;
import com.reuters.rfa.ansipage.Page;
import com.reuters.rfa.ansipage.PageCell;
import com.reuters.rfa.ansipage.PageUpdate;
import com.reuters.rfa.common.Context;

/**
 * <p>Demonstrates using the AnsiPage encoder and decoder in an application.</p>
 *
...
public class AnsiPageDemo {
  ...
  /**
   * main driver of the example program
   */
  public static void main(String[] args){
    AnsiPageDemo demo = new AnsiPageDemo();
    demo.decodeInitialPage();
    demo.setContents();
    demo.updatePage();
    demo.resetPage();
