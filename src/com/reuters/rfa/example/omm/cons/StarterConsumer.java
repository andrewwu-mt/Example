...
/**
 * <p>
 * This is a main class to run StarterConsumer application.
 * </p>
 * 
...
public class StarterConsumer
{
    ...
    private final String _className = "Consumer";

    public StarterConsumer()
    {
        System.out.println("*****************************************************************************");
        System.out.println("*          Begin RFA Java StarterConsumer Program                           *");
        System.out.println("*****************************************************************************");
    }
    ...
    public static void main(String argv[])
    {
        ...
        StarterConsumer demo = new StarterConsumer();
        demo.init();
        demo.run();
        demo.cleanup(0);
    }
