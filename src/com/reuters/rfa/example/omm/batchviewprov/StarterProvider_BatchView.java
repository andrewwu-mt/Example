...
/**
 * <p>
 * StarterProvider_BatchView is a simple interactive server provider example to
 * demonstrate how to interactively publish Reuters Domain Model data using the
 * Open Message Model with batch, view and PAR (Pause and Resume) support.
 * </p>
 * 
 ...
 * the server to request view or batch data.
 * 
 ...
 * 
 */
public class StarterProvider_BatchView implements Client
{
    ...
    HashMap<Handle, BatchViewProviderClientSession> _clientSessions;
	 ...
	 *
	 */
    public StarterProvider_BatchView()
    {
        System.out.println("*****************************************************************************");
        System.out.println("*          Begin RFA Java StarterProvider_BatchView Program                 *");
        System.out.println("*****************************************************************************");
        System.out.println("Initializing Batch View Provider ...");
        readConfiguration();
        Context.initialize();
        _pool = OMMPool.create();
        _clientSessions = new HashMap<Handle, BatchViewProviderClientSession>();
        loadDictionary();
    ...
    private void processActiveClientSessionEvent(OMMActiveClientSessionEvent event)
    {
        ...
        if (_acceptSession) // Application defaults to accept all incoming sessions.
        {
            ...
            BatchViewProviderClientSession pcs = new BatchViewProviderClientSession(this, _service);
    ...
    public static void main(String argv[])
    {
        ...
        StarterProvider_BatchView demo = new StarterProvider_BatchView();
