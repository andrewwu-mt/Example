package com.reuters.rfa.example.omm.prov;
...
{
    private final StarterProvider_Interactive _providerDemo;
    ...
    public ProviderClientSession(StarterProvider_Interactive app, String serviceName)
    {
        _providerDemo = app;
        _pool = app._pool;
    ...
    private void sendUpdates()
    {
        ...
        while (iter.hasNext())
        {
            ...
            for (int i = 0; i < _providerDemo._updateRate; i++)
            {
                ...
                // for the entire message. If size is not large enough,
                // RFA will throw out exception related to buffer usage.
                ...
                // (all other item message models are not supported
                // by this application
    ...
    private void processItemRequest(OMMSolicitedItemEvent event)
    {
        ...
        switch (msg.getMsgType())
        {
            ...
            {
                // need to determine if this is an initial request or a reissue.
                ...
                {
                    // Existing request. a.k.a reissue
                    if(msg.isSet(OMMMsg.Indication.NONSTREAMING))
                    {
                ...
                // Check if the streaming request has priority.
                ...
                if(msg.isSet(OMMMsg.Indication.NONSTREAMING))
                {
                    ...
                    outmsg.setState(OMMState.Stream.NONSTREAMING, OMMState.Data.OK,
                                    OMMState.Code.NONE, "OK");
                }
                else
                {
                    // Set the state of the item stream.
    ...
    private void processDictionaryRequest(OMMSolicitedItemEvent event)
    {
        ...
        byte streamState = OMMState.Stream.OPEN; // Stream state could be OPEN or NONSTREAMING.
