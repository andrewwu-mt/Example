 ...
 * 
 * <p>
 * StarterProvider_Interactive is a simple interactive server provider example
 * to demonstrate how to interactively publish Reuters Domain Model data using
 ...
 * 
 */
public class StarterProvider_Interactive implements Client
{
	 ...
	 *
	 */
    public StarterProvider_Interactive()
    {
        System.out.println("*****************************************************************************");
        System.out.println("*          Begin RFA Java StarterProvider_Interactive Program               *");
        System.out.println("*****************************************************************************");
        System.out.println("Initializing StarterProvider_Interactive ...");
        readConfiguration();
        Context.initialize();
    ...
    public static void main(String argv[])
    {
        ...
        StarterProvider_Interactive demo = new StarterProvider_Interactive();
