...
/**
 * TableModel that manages a time-elapsed fading of updated cells of a JTable
 * from red to black. Using the <code>FadeCellRenderer</code> inner class, this
 * TableModel determines if a particular field's cell last updated whether it
 * should be displayed as red (recently changed) or black.
 */
