 ...
 * <ul>
 * <li>Encoding streamPing request message for Login using OMM message
...
public class PrivateStrmLoginClient implements Client
{
    Handle _loginHandle;
    StarterConsumer_PrivateStream _mainApp;

    private String _className = "PrivateStrmLoginClient";

    /**
     * @param mainApp a reference to the main application class
     */
    public PrivateStrmLoginClient(StarterConsumer_PrivateStream mainApp)
    {
        _mainApp = mainApp;
        _loginHandle = null;
    }
