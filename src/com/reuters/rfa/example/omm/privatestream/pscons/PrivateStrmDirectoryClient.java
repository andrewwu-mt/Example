 ...
 * {@linkplain StarterConsumer_PrivateStream#processDirectoryInfo()}
 * </ul>
 * 
 ...
 * StarterConsumer_PrivateStream for private stream.
 * 
 * @see com.reuters.rfa.example.omm.privatestream.pscons.StarterConsumer_PrivateStream
 * 
 */
public class PrivateStrmDirectoryClient implements Client
{
    private StarterConsumer_PrivateStream _mainApp;
    ...
    private String _className = "PrivateStrmDirectoryClient";

    protected PrivateStrmDirectoryClient(StarterConsumer_PrivateStream mainApp)
    {
        _mainApp = mainApp;
        ...
        if (respMsg.getMsgType() == OMMMsg.MsgType.REFRESH_RESP)
        {
            if ((respMsg.getState().getDataState() == OMMState.Data.OK))
            {
                ...
                for (Iterator<?> iter = map.iterator(); iter.hasNext();)
                {
                    ...
                    String serviceName = mapEntry.getKey().toString(); // Key is
                                                                       // a
                                                                       // service
                                                                       // name.
