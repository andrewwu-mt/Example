 ...
 * <ul>
 * <li>Encoding request message for Login using OMM message
...
public class PrivateStrmGenMsgLoginClient implements Client
{
    Handle _loginHandle;
    StarterConsumer_PrivateStreamGenericMsg _mainApp;

    private String _className = "PrivateStrmGenMsgLoginClient";

    /**
     * @param mainApp PrivateStrmGenMsgConsDemo
     */
    public PrivateStrmGenMsgLoginClient(StarterConsumer_PrivateStreamGenericMsg mainApp)
    {
        _mainApp = mainApp;
        _loginHandle = null;
    }
