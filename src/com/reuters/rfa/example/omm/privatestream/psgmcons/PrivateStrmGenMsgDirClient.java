 ...
 * PrivateStrmGenMsgConsDemo for generic message on private stream.
 * 
 * @see com.reuters.rfa.example.omm.privatestream.psgmcons.StarterConsumer_PrivateStreamGenericMsg
 * 
 */
public class PrivateStrmGenMsgDirClient implements Client
{
    private StarterConsumer_PrivateStreamGenericMsg _mainApp;
    ...
    private String _className = "PrivateStrmGenMsgDirClient";

    protected PrivateStrmGenMsgDirClient(StarterConsumer_PrivateStreamGenericMsg mainApp)
    {
        _mainApp = mainApp;
    ...
    private OMMMsg encodeSrcDirReqMsg()
    {
        ...
        // Specifies the filter information needed.
