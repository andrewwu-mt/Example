 ...
 * {@linkplain StarterConsumer_Post#processDirectoryInfo()}
 * </ul>
 * 
 ...
 * 
 * @see com.reuters.rfa.example.omm.postingConsumer.StarterConsumer_Post
 * 
 */
public class DirectoryClient implements Client
{
    private StarterConsumer_Post _mainApp;
    ...
    private String _className = "PostingConsumerDirectoryClient";

    protected DirectoryClient(StarterConsumer_Post mainApp)
    {
        _mainApp = mainApp;
