...
/**
 * ItemObj is a class that contains all the relevant information regarding an item.
 * It is used as the source of canned data for the StarterProviderInteractive_Chain.
 * 
 */
