 ...
 * <li>Implement a Client which processes events from a
 * <code>OMMGenericMsgConsumer</code> and handle Login responses</li>
...
public class LoginClient implements Client
{
    ...
    public LoginClient(StarterConsumer_GenericMsg mainApp)
    {
        _mainApp = mainApp;
        _loginHandle = null;
    }
