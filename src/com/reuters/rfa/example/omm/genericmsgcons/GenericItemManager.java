...
/**
 * <p>
 * The is a Client class that handle request, response and generic messages for
 ...
 *  	generic messages with the example application StarterProvider_GenericMsg.
 ...
 * StarterConsumer_GenericMsg
 * 
 * @see StarterConsumer_GenericMsg
 * 
 */
public class GenericItemManager implements Client
{
    ...
    StarterConsumer_GenericMsg _mainApp;

    private String _className = "GenericItemManager";
    private int _genericMsgsSent = 0;
    private final String _serviceName = "DIRECT_FEED";
    private final String _itemName = "TALK";

    public GenericItemManager(StarterConsumer_GenericMsg mainApp)
    {
        _mainApp = mainApp;
    }
    ...
    public void sendRequest()
    {
        ...
        Handle lhd = _mainApp.getLoginHandle();
    ...
    private void sendGenericMsg(Handle itemHandle)
    {
        ...
        // set negotiated version info
        if (itemHandle != null)
        {
            msg.setAssociatedMetaInfo(itemHandle);
        }
        /* put payload in */
