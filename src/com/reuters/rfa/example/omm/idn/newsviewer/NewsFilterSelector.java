...
public class NewsFilterSelector
{
    ...
    public void initGUI()
    {
        ...
        _attribtn = new JList(_codeDb._attributionLM);
        ...
        _prod_code = new JList(_codeDb._prodCodesLM);
        ...
        _topic_code = new JList(_codeDb._topicCodesLM);
        ...
        _lang_ind = new JList(_codeDb._langsLM);
        ...
        _co_ids = new JList(_codeDb._companyCodesLM);
    ...
    private String getSelectedValue(JList list)
    {
        ...
        {
            s.append(escapeRegex(a[i].toString()));
            if (++i < a.length)
                s.append("|");
        }
        s.append(")");
    ...
    void appendSelection(StringBuilder expression, String attrib, JList list)
    {
        Object[] a = list.getSelectedValues();
        if (a.length == 0)
            return;
    ...
    JFrame _selectionDialog;
    JTextField _expression;
    JPanel _panel;
    JTextField _filter;
    JButton _open;
    JList _prod_code, _lang_ind, _co_ids, _topic_code, _attribtn;
