...
public class NewsCodeDb
{
    public NewsCodeDb(NewsFilterSelector newsFilterSelector)
    {
        ...
        _attributionLM = new DefaultListModel();
        _attributionLM.addElement("RTRS");
        _topicCodesLM = new DefaultListModel();
        _companyCodesLM = new DefaultListModel();
        _prodCodesLM = new DefaultListModel();
        _langsLM = new DefaultListModel();
    ...
    void dump(String title, DefaultListModel values)
    {
    ...
    DefaultListModel _attributionLM;
    DefaultListModel _topicCodesLM;
    DefaultListModel _companyCodesLM;
    DefaultListModel _prodCodesLM;
    DefaultListModel _langsLM;
