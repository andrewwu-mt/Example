...
public class ItemInfo
{
	...
	public void setAttribInUpdates(boolean b) { _attribInUpdates = b;}
	public boolean getAttribInUpdates() { return _attribInUpdates; }
	...
	public int getPriorityCount() { return _priorityCount; }
	public void setPriorityCount(int priorityCount) { _priorityCount = priorityCount;}

	public int getPriortyClass() { return _priorityClass; }
	public void setPriorityClass(int priorityClass) { _priorityClass = priorityClass; }

	public void setHandle(Handle handle) { _handle = handle; }
	public Handle getHandle() { return _handle; }
	
	public void setPaused(boolean pause) { _isPaused = pause; }
